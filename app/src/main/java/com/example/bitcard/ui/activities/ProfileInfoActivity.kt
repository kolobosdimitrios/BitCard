...
import com.example.bitcard.BuildConfig
...
import com.example.bitcard.ui.dialogs.SelectImageBottomSheetDialogFragment
import com.example.bitcard.SharedPreferencesHelpers
import com.example.bitcard.network.data.requests.RegisterModel
import com.example.bitcard.network.data.requests.UserDataSenderObj
import com.example.bitcard.network.data.responses.GetUserResponse
...
import com.example.bitcard.ui.result_launchers.PermissionResultGenerified
...
class ProfileInfoActivity : AppCompatActivity() {
    ...
    private fun getUserDataFromHTTP(userId: Long){
        ...
        APIClient.newInstance.get(userId).enqueue(object : Callback<GetUserResponse> {
    ...
    private fun uploadUserImage(user_id: Long, image: Bitmap){
        ...
        APIClient.newInstance.updateUsersProfilePicture(user_id = user_id, registerModel = registerModel).enqueue(object : Callback<SimpleResponse<Any>>{
            override fun onResponse(
