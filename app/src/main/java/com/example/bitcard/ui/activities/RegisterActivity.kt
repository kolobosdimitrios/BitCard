...
class RegisterActivity : AppCompatActivity(), View.OnFocusChangeListener {
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email,password)
            .addOnCompleteListener{ result ->
                ...
                if (result.isSuccessful) {
                    ...
                    //if user gets a uid then creation in Firebase auth service
                    //is successful
                    result.result.user?.uid?.let {
                        ...
                        //Send new user's data to database using model
    ...
    private fun sendCreateUserRequest(user: UserDataSenderObj){
        ...
        APIClient.newInstance.register(register).enqueue(object : Callback<GetUserResponse> {
